...
import MugZoneCanvas from "./MugZoneCanvas";
...
export default function MugCustomizerPanel({
  product,
  onDesignReady,
  onClear,
  activeDesign,
  ...
  const handleGenerate = async () => {
    ...
    try {
      const zoneName = activeZone ? activeZone.replace(/_/g, " ") : "mug";
      const fullPrompt = `${prompt.trim()}, for the ${zoneName} of a mug, product print design, transparent background, high quality`;
  ...
  return (
    <div className="tsc-root">
      {activeDesign?.type === "mug" && (
        <div className="tsc-active-design-bar">
          <FaCheckCircle />
          <span>Mug design applied to your order.</span>
          <button
            type="button"
        ...
        <div className="tsc-sidebar">
          ...
          <div className="tsc-sidebar-section">
            ...
            <textarea
              ...
              placeholder={`Describe the image… e.g. "floral pattern"`}
              value={prompt}
        ...
        <div className="tsc-main-col">
          ...
          <div className="tsc-preview-panel">
            ...
            <div className="tsc-color-section">
              <div className="tsc-color-label">MUG COLOR</div>
