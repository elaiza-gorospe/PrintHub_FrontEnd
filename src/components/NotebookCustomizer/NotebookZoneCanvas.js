/**
 * NotebookZoneCanvas
 * Renders a 1×2 grid of print zones (front cover, back cover).
 * Each zone supports drag and resize for a placed image.
 *
 * Props:
 ...
 *   onZoneDesignChange {fn}        – called with (zoneId, layer)
 */
import React, { useCallback, useRef } from "react";
import "../TshirtCustomizer/TshirtCustomizer.css";

const ZONE_META = [
  { id: "front_cover", label: "FRONT COVER", col: 1, row: 1 },
  { id: "back_cover", label: "BACK COVER", col: 2, row: 1 },
];
...
export default function NotebookZoneCanvas({
  zones = [],
  zoneDesigns = {},
  activeZone,
  onZoneSelect,
